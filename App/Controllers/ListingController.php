...
class ListingController
{
    ...
    public function search()
    {
        ...
        $query = "SELECT * FROM listings WHERE (title LIKE :keywords1 OR description LIKE
        :keywords2 OR tags LIKE :keywords3 OR company LIKE :keywords4) AND (city LIKE :location1 
        OR state LIKE :location2)";
